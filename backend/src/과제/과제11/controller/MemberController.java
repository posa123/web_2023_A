...
public class MemberController {
	...
	public int getLoginSession() {return longinSession; }
	// 3. 로그인 처리
	...
	public MemberDto info() {
		return MemberDao.getInstance().info(this.loginSession);	// 실패
	}
	// 7.
	...
	public boolean infoDelete() {
		return MemberController.getInstance().infoDelete(loginSession); // 실패
	}
}
