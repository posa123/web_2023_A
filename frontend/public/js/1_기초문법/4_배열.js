/*
	...
	7. 배열내 데이터 추가
			배열명.push( 새로운값 )		:	배열내 마지막 위치에 저장
				-마지막 인덱스 
			배열명.splice( 위치인덱스 , 0 , 새로운값 ) : 해당 위치인덱스에 새로운값 저장
				-특정 위치/인덱스 에 데이터 추가
	...
	9. 배열내 데이터를 이용한 데이터 삭제
			- 배열명.indexof('찾을데이터') : 찾을데이터가 존재하면 찾은인덱스번호 아니면 -1
...
document.write( '<ol>')// HTML 문자처리 o
document.write( 	'<li>'+배열명[0]+'</li>' ) // 변수 or 배열 문자처리x
document.write( 	'<li>'+배열명[1]+'</li>' ) // 변수 or 배열 문자처리x
document.write( 	'<li>'+배열명[2]+'</li>' ) // 변수 or 배열 문자처리x
document.write( 	'<li>'+배열명[3]+'</li>' ) // 변수 or 배열 문자처리x
document.write( '<ol>')
// 예제4 : 인덱스를 이용한 데이터 수정
...
// 예제5 : 배열에 요소/데이터추가
배열명.push( '체리' ); // push('체리') : 배열내 마지막 요소/데이터 뒤에 '체리' 추가
console.log( 배열명 )
배열명.splice( 2 , 0 , '복숭아' ) // 0번째 인덱스에서 0개 자르고 '복숭아' 추가
console.log( 배열명 )
...
배열명.splice( 배열명.indexOf('딸기') , 1 )// '딸기' 삭제 하는데 인덱스번호를 모른상태
	//1.배열명.indexOf('딸기') => 2 
	//2. 배열명.splice( 2 , 1 ) => 2번 인덱스부터 1개 삭제
console.log( 배열명 ) //'딸기' 제거
