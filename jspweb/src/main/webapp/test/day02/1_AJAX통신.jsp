...
<body>
	...
	<h6> 1. [문자타입] JS 에서 servlet[자바웹클래스] 에게 통신하고 데이터 반환 받기 </h6>
	<button onclick="예제1()" type="button">예제1</button>
	
	<h6> 2.[문자타입/한글인코딩] JS 에서 servlet[자바웹클래스] 에게 통신하고 데이터 반환 받기 </h6>
	<button onclick="예제2()" type="button">예제2</button>
	
	<h6> 3.[JSON] JS 에서 servlet[자바웹클래스] 에게 통신하고 데이터 반환 받기 </h6>
	<button onclick="예제3()" type="button">예제3</button>
	
	<h6> 4.[JSON] JS 에서 servlet[자바웹클래스] 에게 통신하고 데이터 반환 받기 </h6>
