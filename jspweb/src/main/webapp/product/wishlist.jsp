...
<body>
	...
	<div class="container" style="border: 1px solid red;"> <!-- bs : container 디바이스 크기에 따른 반응형 구역 -->
		<h3> 찜 목록 현황 </h3>
		<table class="table table-hover text-center align-middle"> <!-- bs : table 기본css 적용된 테이블 -->
			<tr>
			...
			<tr>
				...
				<td> <img src="/jspweb/product/img/toybus.jpg" width="100%"> </td>
				<td> 노트북 팝니다. </td>
				<td> 655,555 </td>
